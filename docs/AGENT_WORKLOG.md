...
| 2026-08-28 | 서버 전용 OpenAI 문장화 및 결정론적 fallback | core-logic (Luna Max) | 1.2.0 | IN_PROGRESS | `services/openai_service.py`, `api/index.py`, 관련 오프라인 테스트 | 기준선 harness·Python 25/25·frontend 44/44·lint 통과; 구현·독립 review 대기 | 0 | Task 6; Responses API 구조화 출력, 기존 근거 ID와 사실 보존, 키·timeout·provider·검증 실패 fallback 범위 |
