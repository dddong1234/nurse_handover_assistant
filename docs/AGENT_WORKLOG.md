...
| 2026-08-28 | 서버 전용 OpenAI 문장화 및 결정론적 fallback | core-logic (Luna Max) | 1.2.0 | REVISION | `services/openai_service.py`, `api/index.py`, 관련 오프라인 테스트 | 기준선 통과; 1차 독립 review에서 의미 반전·차용 숫자·투약 빈도 누락·무근거 문구 삭제·소수점 문장 분리 결함 확인 | 1 | Task 6; 원 구현자 수정 라운드 1/5 진행 |
