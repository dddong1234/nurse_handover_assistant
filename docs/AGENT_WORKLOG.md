...
| 2026-08-31 | Figma 기반 통합 임상 워크벤치 재설계 | supervisor | 1.2.0 | PLANNED | 전역 임상 헤더, 담당 환자 레일, 비교·원본 기록 중앙 모듈, 인계 검토 레일의 단일 프로그램 구조 | Figma design node `39:3` context·screenshot과 현재 `0.6.0` 컴포넌트/제품 명세 대조; 구현 전 설계 명세 작성 | 0 | 임상·API 계약 변경 없음. 사용자 명세 검토 후 구현 계획과 Luna Max 프런트 작업 시작 |
